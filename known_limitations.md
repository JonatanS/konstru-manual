...
# ETABS
## Plugin
ETABS supports the external plugins. Konstru Cloud is developed as plugin and can be reached within ETABS models. The external plug-in has to be added manually Tools > Add/ShowPlugins > Add your plug-in. Please see instructions.

## Custom Profiles
Custom sections in regular shapes (I,C,W,Rectangular etc) are supported. Custom profiles can be created via Section Designer while Konstru download. The irregular shapes currently are not translate via Konstru.
